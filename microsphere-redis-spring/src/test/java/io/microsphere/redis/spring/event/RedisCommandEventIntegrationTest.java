...
/**
 * {@link RedisCommandEvent} Integration Test
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy</a>
 * @since 1.0.0
 */
@ContextConfiguration(classes = RedisCommandEventIntegrationTest.class)
@TestPropertySource(properties = {
        "microsphere.redis.enabled=true"
})
@EnableRedisInterceptor
class RedisCommandEventIntegrationTest extends AbstractRedisCommandEventTest {
}
