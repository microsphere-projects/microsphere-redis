...
/**
 * {@link InMemoryRedisMetadataRepository} Test
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy</a>
 * @see InMemoryRedisMetadataRepository
 * @since 1.0.0
 */
class InMemoryRedisMetadataRepositoryTest {

    private RedisMetadataRepository redisMetadataRepository;

    @BeforeEach
    void setUp() {
        this.redisMetadataRepository = new InMemoryRedisMetadataRepository();
        this.redisMetadataRepository.init();
    }
    ...
    @Test
    void testFindRedisCommandMethod() {
    }
