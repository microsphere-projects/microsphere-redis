...
[![Codecov](https://codecov.io/gh/microsphere-projects/microsphere-redis/branch/dev-1.x/graph/badge.svg)](https://app.codecov.io/gh/microsphere-projects/microsphere-redis)
...
|--------------|-------------------------------------------------|--------------------|
| **0.2.x**    | Compatible with Spring Data Redis 3.0.0 - 3.5.x | 0.2.4              |
| **0.1.x**    | Compatible with Spring Data Redis 2.1.0 - 2.7.x | 0.1.4              |
